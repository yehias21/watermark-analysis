...
from ..config import DEFAULT_DISTORTION_STRENGTHS
from .base import Attack

VALID_IMAGE_EXTENSIONS = {'.jpg', '.jpeg', '.png', '.bmp'}


class DistortionAttacks(Attack):
    def __init__(self):
        super().__init__()
    ...
    def apply(self, image, distortion_type: str = "rotation"):
        """Attack ABC entry point: apply a single distortion to ``image``."""
        return self.process_single_image(image, distortion_type)
