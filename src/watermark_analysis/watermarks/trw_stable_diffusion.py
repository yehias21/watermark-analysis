...
from ..config import (
    SD_GUIDANCE_SCALE as DEFAULT_GUIDANCE_SCALE,
    SD_HEIGHT as DEFAULT_HEIGHT,
    SD_MODEL_V2 as DEFAULT_MODEL,
    SD_NUM_INFERENCE_STEPS as DEFAULT_NUM_INFERENCE_STEPS,
    SD_WIDTH as DEFAULT_WIDTH,
    TRW_DEVICE_OVERRIDE as DEVICE_OVERRIDE,
...
from .modified_sd_pipeline import ModifiedStableDiffusionPipeline
from .trw import Trw

DEFAULT_CHANNEL = 3  # note: differs from Trw default (-1); kept for parity
